                            ...
                            with open(file, "r") as fp:
                                ...
                                if dset_value == 'mnist':
                                    mnist_df = mnist_df.append(
                                        {'Dataset': dset_value, 'Select every': select_value, 'Strategy': strategy_name,
                                         'Budget': bud_value, 'Accuracy': tst_acc, 'Time': tim}, ignore_index=True)
                                elif dset_value == 'fashion-mnist':
                                    fmnist_df = fmnist_df.append(
                                        {'Dataset': dset_value, 'Select every': select_value, 'Strategy': strategy_name,
                                         'Budget': bud_value, 'Accuracy': tst_acc, 'Time': tim}, ignore_index=True)
                                elif dset_value == 'cifar10':
                                    cifar10_df = cifar10_df.append(
                                        {'Dataset': dset_value, 'Select every': select_value, 'Strategy': strategy_name,
                                         'Budget': bud_value, 'Accuracy': tst_acc, 'Time': tim}, ignore_index=True)
                                elif dset_value == 'cifar100':
                                    cifar100_df = cifar100_df.append(
                                        {'Dataset': dset_value, 'Select every': select_value, 'Strategy': strategy_name,
                                         'Budget': bud_value, 'Accuracy': tst_acc, 'Time': tim}, ignore_index=True)
                                elif dset_value == 'svhn':
                                    svhn_df = svhn_df.append(
                                        {'Dataset': dset_value, 'Select every': select_value, 'Strategy': strategy_name,
                                         'Budget': bud_value, 'Accuracy': tst_acc, 'Time': tim}, ignore_index=True)
...
# Vectorized pairwise distance for numpy
